...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Use 'get_dimension_schema' to fetch the JSON Schema definition for any mind "
        "dimension by its path (e.g. dimension='manas'), so CXOs can understand the "
        "semantics of their atomic state files without needing the internal schema name.  "
